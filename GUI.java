...
public class GUI implements ActionListener{
	...
	//format menu
	JMenuItem iWrap,iFontArial,iFontCSMS,iFontTNR,iFontMS,iFontSize8,iFontSize12,iFontSize16,iFontSize20,iFontSize24,iFontSize28;
	...
	public void createWindow() {
		window = new JFrame("Yet Another Notepad Application");
	...
	public void createColorMenu(){
		...
		iColor2 = new JMenuItem("Grey");
		iColor2.addActionListener(this);
		iColor2.setActionCommand("Grey");
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Monospace" : format.setFont(command);break;
		...
		case "Grey" : color.changeColor(command);break;
